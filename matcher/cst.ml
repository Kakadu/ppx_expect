...
let is_conflict_marker s =
  String.equal s "======="
  || ListLabels.exists [ "<<<<<<< "; "||||||| "; ">>>>>>> " ] ~f:(fun prefix ->
    String.starts_with s ~prefix)
;;

let is_spaces s = for_all_string s ~f:is_space
let no_nl s = for_all_string s ~f:(fun c -> not (Char.equal c '\n'))
...
module Line = struct
  ...
  let sexp_of_not_blank : 'a. ('a -> Sexplib0.Sexp.t) -> 'a not_blank -> Sexplib0.Sexp.t =
    fun _of_a__001_
      ...
      in
      let bnds__002_ =
        let arg__006_ = Sexplib.Conv.sexp_of_string orig__005_ in
        (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "orig"; arg__006_ ] :: bnds__002_
         : _ Stdlib.List.t)
      in
      let bnds__002_ =
        let arg__004_ = Sexplib.Conv.sexp_of_string trailing_blanks__003_ in
  ...
  let compare_not_blank : 'a. ('a -> 'a -> int) -> 'a not_blank -> 'a not_blank -> int =
    ...
    then 0
      ...
      match String.compare a__009_.trailing_blanks b__010_.trailing_blanks with
      | 0 ->
        (match String.compare a__009_.orig b__010_.orig with
  ...
  let equal_not_blank : 'a. ('a -> 'a -> bool) -> 'a not_blank -> 'a not_blank -> bool =
    ...
    then true
      ...
      Stdlib.( && )
        (String.equal a__011_.trailing_blanks b__012_.trailing_blanks)
        (Stdlib.( && )
           (String.equal a__011_.orig b__012_.orig)
  ...
  let sexp_of_t : 'a. ('a -> Sexplib0.Sexp.t) -> 'a t -> Sexplib0.Sexp.t =
    ...
    fun _of_a__013_ -> function
      | Blank arg0__014_ ->
        let res0__015_ = Sexplib.Conv.sexp_of_string arg0__014_ in
        Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "Blank"; res0__015_ ]
      | Conflict_marker arg0__016_ ->
        let res0__017_ = Sexplib.Conv.sexp_of_string arg0__016_ in
  ...
  let compare : 'a. ('a -> 'a -> int) -> 'a t -> 'a t -> int =
    ...
    then 0
      ...
      | Blank _a__023_, Blank _b__024_ -> String.compare _a__023_ _b__024_
      | Blank _, _ -> -1
      | _, Blank _ -> 1
      | Conflict_marker _a__025_, Conflict_marker _b__026_ ->
        String.compare _a__025_ _b__026_
  ...
  let equal : 'a. ('a -> 'a -> bool) -> 'a t -> 'a t -> bool =
    ...
    then true
      ...
      | Blank _a__033_, Blank _b__034_ -> String.equal _a__033_ _b__034_
      | Blank _, _ -> false
      | _, Blank _ -> false
      | Conflict_marker _a__035_, Conflict_marker _b__036_ ->
        String.equal _a__035_ _b__036_
  ...
  let strip = function
    | Blank _ -> Blank ""
    | Conflict_marker c -> Conflict_marker (Utils.string_rstrip c)
...
let sexp_of_single_line : 'a. ('a -> Sexplib0.Sexp.t) -> 'a single_line -> Sexplib0.Sexp.t
  ...
  fun _of_a__041_
    ...
    in
    let bnds__042_ =
      let arg__048_ = Sexplib.Conv.sexp_of_string orig__047_ in
      (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "orig"; arg__048_ ] :: bnds__042_
       : _ Stdlib.List.t)
    in
    let bnds__042_ =
      let arg__046_ = Sexplib.Conv.sexp_of_string trailing_spaces__045_ in
      (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "trailing_spaces"; arg__046_ ] :: bnds__042_
       : _ Stdlib.List.t)
    in
    let bnds__042_ =
      let arg__044_ = Sexplib.Conv.sexp_of_string leading_blanks__043_ in
...
let compare_single_line : 'a. ('a -> 'a -> int) -> 'a single_line -> 'a single_line -> int
  ...
  then 0
    ...
    match String.compare a__051_.leading_blanks b__052_.leading_blanks with
    | 0 ->
      (match String.compare a__051_.trailing_spaces b__052_.trailing_spaces with
       | 0 ->
         (match String.compare a__051_.orig b__052_.orig with
...
let equal_single_line : 'a. ('a -> 'a -> bool) -> 'a single_line -> 'a single_line -> bool
  ...
  then true
    ...
    Stdlib.( && )
      (String.equal a__053_.leading_blanks b__054_.leading_blanks)
      (Stdlib.( && )
         (String.equal a__053_.trailing_spaces b__054_.trailing_spaces)
         (Stdlib.( && )
            (String.equal a__053_.orig b__054_.orig)
...
let sexp_of_multi_lines : 'a. ('a -> Sexplib0.Sexp.t) -> 'a multi_lines -> Sexplib0.Sexp.t
  ...
  fun _of_a__055_
    ...
    let bnds__056_ =
      let arg__064_ = Sexplib.Conv.sexp_of_list (Line.sexp_of_t _of_a__055_) lines__063_ in
      (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "lines"; arg__064_ ] :: bnds__056_
       : _ Stdlib.List.t)
    in
    let bnds__056_ =
      let arg__062_ = Sexplib.Conv.sexp_of_string indentation__061_ in
      (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "indentation"; arg__062_ ] :: bnds__056_
       : _ Stdlib.List.t)
    in
    let bnds__056_ =
      let arg__060_ = Sexplib.Conv.sexp_of_string trailing_spaces__059_ in
      (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "trailing_spaces"; arg__060_ ] :: bnds__056_
       : _ Stdlib.List.t)
    in
    let bnds__056_ =
      let arg__058_ = Sexplib.Conv.sexp_of_string leading_spaces__057_ in
...
let compare_multi_lines : 'a. ('a -> 'a -> int) -> 'a multi_lines -> 'a multi_lines -> int
  ...
  then 0
    ...
    match String.compare a__065_.leading_spaces b__066_.leading_spaces with
    | 0 ->
      (match String.compare a__065_.trailing_spaces b__066_.trailing_spaces with
       | 0 ->
...
let equal_multi_lines : 'a. ('a -> 'a -> bool) -> 'a multi_lines -> 'a multi_lines -> bool
  ...
  then true
    ...
    Stdlib.( && )
      (String.equal a__071_.leading_spaces b__072_.leading_spaces)
      (Stdlib.( && )
         (String.equal a__071_.trailing_spaces b__072_.trailing_spaces)
         (Stdlib.( && )
            (String.equal a__071_.indentation b__072_.indentation)
            (List.equal
...
let sexp_of_t : 'a. ('a -> Sexplib0.Sexp.t) -> 'a t -> Sexplib0.Sexp.t =
  ...
  fun _of_a__077_ -> function
    | Empty arg0__078_ ->
      let res0__079_ = Sexplib.Conv.sexp_of_string arg0__078_ in
...
let compare : 'a. ('a -> 'a -> int) -> 'a t -> 'a t -> int =
  ...
  then 0
    ...
    | Empty _a__087_, Empty _b__088_ -> String.compare _a__087_ _b__088_
    | Empty _, _ -> -1
    | _, Empty _ -> 1
...
let equal : 'a. ('a -> 'a -> bool) -> 'a t -> 'a t -> bool =
  ...
  then true
    ...
    | Empty _a__099_, Empty _b__100_ -> String.equal _a__099_ _b__100_
    | Empty _, _ -> false
    | _, Empty _ -> false
...
let invariant inv t =
  ...
  | Multi_lines m ->
    ...
    ListLabels.iter m.lines ~f:(Line.invariant inv);
    (match m.lines with
     | [] -> assert false
     | Blank _ :: _ -> assert false
     | [ Not_blank n ] ->
       assert (ld_len > 0 && (tr_has_nl || Utils.string_is_empty n.trailing_blanks))
     | l ->
       let rec check_last = function
         | ([] : _ Line.t list) -> assert false
         | [ Blank _ ] -> assert false
         | [ Not_blank n ] -> assert (tr_has_nl || Utils.string_is_empty n.trailing_blanks)
         | [ Conflict_marker m ] -> assert (not (Utils.string_is_empty m))
...
let map t ~f =
  ...
  | Multi_lines m -> Multi_lines { m with lines = ListLabels.map m.lines ~f:(Line.map ~f) }
;;
...
let data t ~blank ~conflict_marker =
  ...
  | Multi_lines m -> ListLabels.map m.lines ~f:(Line.data ~blank ~conflict_marker)
;;
...
let stripped_original_lines t =
  ...
  | Multi_lines m -> ListLabels.map m.lines ~f:Line.orig
;;
    ...
    (match m.lines with
     ...
     | lines ->
       Multi_lines
         ...
         ; trailing_spaces = ""
         ; indentation = ""
         ; lines = List.map Line.strip lines
         })
;;
...
let to_string t =
  ...
  | Multi_lines m ->
    ...
    in
    let s = List.map indent m.lines |> String.concat "\n" in
...
let not_blank_or_conflict_lines lines =
  ListLabels.fold_left lines ~init:[] ~f:(fun acc (l : _ Line.t) ->
    match l with
...
let longest_common_prefix a b =
  ...
  StringLabels.sub a ~pos:0 ~len:!i
;;
...
let extract_indentation lines =
  ...
  | [] -> "", lines
  | first :: rest ->
    let indent = ListLabels.fold_left rest ~init:(indentation first) ~f:longest_common_prefix in
    ...
    let update_line : 'a Line.t -> 'a Line.t = function
      ...
      | Not_blank n ->
        let orig =
          StringLabels.sub n.orig ~pos:indent_len ~len:(String.length n.orig - indent_len)
        in
        Not_blank { n with orig }
    in
    indent, ListLabels.map lines ~f:update_line
;;

let break s at = Utils.string_prefix s at, Utils.string_drop_prefix s at
